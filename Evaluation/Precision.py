...
def evaluate_precision(queries, name):
    if name == "A":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Antique/WE_precision@10.txt"
    if name == "Q":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Quora/WE_precision@10.txt"
