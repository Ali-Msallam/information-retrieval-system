...
def evaluate_recall(queries, name):
    if name == "A":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Antique/WE_Recall.txt"
    if name == "Q":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Quora/TFIDF_Recall.txt"
