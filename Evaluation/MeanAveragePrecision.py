...
def evaluate_mean_average_precision(queries, name):
    ...
    if name == "A":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Antique/WE_MAP.txt"
    if name == "Q":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Quora/TFIDF_MAP.txt"
