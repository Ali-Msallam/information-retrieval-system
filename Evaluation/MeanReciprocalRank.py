...
def evaluate_mean_reciprocal_rank(queries, name):
    if name == "A":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Antique/WE_MRR.txt"
    if name == "Q":
        output_file = "C:/Users/LENPOVO/Information-Retrieval-System-main/Evaluation/Results/Quora/WE_MRR.txt"
